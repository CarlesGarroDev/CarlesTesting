...
public class sendRequestLeadNoLogin {
	...
	public void BnoLoginSendRequestChrome() {
		...
		driver.findElement(messageArea).sendKeys(
				"!·.··>> 04/12/2019 lorem daily changes whats played has been the industry's standard dummy text ever since the 1500s");
	...
	public void EnoLoginSendRequestFirefox() {
		...
		driver.findElement(messageArea).sendKeys(
				"!!$--·>> 04/12/2019 changes to change it more changes to test push notifications!! en Lorem Ipsum has been the industry's standard dummy text ever since the 1500s");
